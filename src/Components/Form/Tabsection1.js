...
<Box sx={{ display: 'flex', flexDirection: 'column', '& > :not(style)': { m: 1 } }}>
        ...
        <Accordion expanded={parentAccordionExpanded} onChange={handleParentAccordionToggle} sx={{ width: '100%', marginTop: '15px' }}>
          <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="parent-panel-content" id="parent-panel-header">
...
<Accordion sx={{ width: '100%', marginTop: '15px' }}>
          <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="executive-summary-content" id="executive-summary-header">
            <Typography variant="h5" component="h1" gutterBottom sx={{ color: 'text.secondary', my: 2 }}>
...
<h2 style={{ fontSize: '1.2rem',fontWeight: 'bold' }}>2.A: Type of Merchant Business (check all that apply)</h2>
      ...
      >
        <h2 style={{ fontSize: '1.2rem',fontWeight: 'bold' }}>2.B: Description of Payment Card Business</h2>
      </AccordionSummary>
      <AccordionDetails
style={detailsStyle}>
...
<Accordion expanded={expandedPanel === 'panelLocations'} onChange={handleAccordionChange('panelLocations')}>
      ...
      >
<h2 style={{ fontSize: '1.2rem',fontWeight: 'bold' }}>2.C: Locations</h2>
...
<Accordion>
      ...
      >
         <h2  style={{ fontSize: '1.2rem',fontWeight: 'bold' }}>2.D: Payment Application</h2>
      </AccordionSummary>
      <AccordionDetails>
  ...
  Add Application
    ...
    <Accordion>
      <AccordionSummary
        ...
        id="panel2e-header"
      >
         <h2  style={{ fontSize: '1.2rem',fontWeight: 'bold' }}>2.E Description of Environment</h2>
      </AccordionSummary>
      <AccordionDetails>
    ...
    <Accordion>
      <AccordionSummary
        ...
        id="panel2f-header"
      >
        <h2  style={{ fontSize: '1.2rem',fontWeight: 'bold' }}>2.F Third-Party Service Providers</h2>
      </AccordionSummary>
      <AccordionDetails>
